...
def pak_law_gpt(question):
    ...
    You should answer all related Pakistani Law, and constitution and article or judiciary or civil law or criminal law.
    ...
    If someone asks you anything unrelated like what is the wheather or is paksitan biryani okay like these absurb questions then, kindly respond by saying: 'Sorry, I am only able to provide answers about the Constitution of Pakistan. Please ask me questions related to that topic.'
"""
    DOC_PROMPT = ''
